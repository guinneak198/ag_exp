...
with figlist_var() as fl:
    with GDS_scope() as g:
        ...
        g.CH2.voltscal=expected_amp*1.1/4 # set to a little more than amp/5
    ...
    text(0.5,0.05,s='$V_{amp}=%0.6f$ mV, voltage ratio %0.8g, dB %0.6f'%(
